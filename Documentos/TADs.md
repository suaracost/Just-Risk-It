...
- cifrar(string secuencia): Cifra una cadena de texto utilizando los códigos Huffman.
- desCifrar(string cif, long longiSec): Descifra una cadena de texto utilizando los códigos de Huffman.
- deCodificar(HuffmanNodo *nodo, char dir, int &cont, string &des): Recibe una cadena de caracteres binarios y decodifica la secuencia mientras crea el árbol.
